# Final Project - KPI Dashboard Analysis

## Project Overview

### Dataset Description, DO THIS
...
### Objectives (Business problem):	, DO THIS
...
### Data Preparation (Data Cleaning in Power Query):, DO THIS
...
* Added the Company Name and Logo to the report using a text box visual.
  ...
  <img width="1154" height="546" alt="Final Project - KPI Dashboard image" src="https://github.com/user-attachments/assets/31692f77-6305-4658-ac22-7f3d0309a4bf" />
